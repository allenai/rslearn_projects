...
export DATASET_PATH=/weka/dfive-default/yawenz/datasets/scratch_ft_v4/dataset
export NUM_WORKERS=32
export TRAINER_DATA_PATH=/weka/dfive-default/yawenz/test/nandi
export WANDB_PROJECT=2025_10_17_nandi_crop_type
export WANDB_NAME=nandi_crop_type_segment_helios_base_S2_ts_ws5_ps1
export WANDB_ENTITY=eai-ai2
python -m rslp.main olmoearth_run prepare_labeled_windows --project_path /weka/dfive-default/yawenz/rslearn_projects/olmoearth_run_data/nandi/finetune --scratch_path /weka/dfive-default/yawenz/datasets/scratch_ft_v4
export GROUP_PATH=/weka/dfive-default/yawenz/datasets/scratch_ft_v4/dataset/windows/spatial_split
