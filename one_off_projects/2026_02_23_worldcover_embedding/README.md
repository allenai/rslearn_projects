...
- `config_worldcover_ps4_bicubic.yaml`: patch_size=4, bicubic interpolation + linear layer (768 -> 13).
...
# This creates a 2048x2048 pixel window (at 10 m/pixel) centered at the point passed via --box.
