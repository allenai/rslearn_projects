...
# sp
python -m rslp.main common beaker_train --config_paths+=data/helios/v2_sentinel2_vessel_attribute/basecfg.yaml --config_paths+=data/helios/v2_sentinel2_vessel_attribute/basecfg_sp.yaml --config_paths+=data/helios/v2_shared/sp.yaml --project_id 2025_06_06_helios_finetuning --experiment_id v2_sentinel2_vessel_attribute_sp --cluster+=ai2/ceres --cluster+=ai2/jupiter '--weka_mounts+={"bucket_name":"dfive-default","mount_path":"/weka/dfive-default"}' --image_name favyen/rslphelios13
```
