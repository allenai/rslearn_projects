"""Definitions for prometheus metrics that are captured during inference to report on performance of the sentinel2 detection service."""
...
request_timer = Histogram(
    "sentinel2_rslearn_timer", "Timers for inference requests",
    labelnames=["operation"],
    buckets=[0.01, 0.05, 0.1, 0.5, 1, 2, 5, 10, 30, 60, 120, (60 * 3), (60 * 4), (60 * 5), (60 * 6), (60 * 7), (60 * 8),
             (60 * 9), (60 * 10)]
)
