...
```
python -m rslp.olmoearth_lcc.annotation_scripts.phase16_mining_datasets.gen_phase16 \
    --data-dir data_dir/
python -m rslp.olmoearth_lcc.annotation_scripts.phase16_mining_datasets.combine_validate \
