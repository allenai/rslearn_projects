...
TASK_CONFIGS = {
    ...
    "small_landsat_vessel_length": ["small_landsat_vessel_length"],
    "small_landsat_vessel_type": ["small_landsat_vessel_type"],
    "small_sentinel1_vessel_length": ["small_sentinel1_vessel_length"],
    "small_sentinel1_vessel_type": ["small_sentinel1_vessel_type"],
