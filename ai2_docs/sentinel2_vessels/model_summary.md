...
- **Model Name**: Sentinel-2 Vessel Detection
- **Model Version**: `v0.0.1`
- **Tag**: `sentinel2_vessels_v0.0.1`
- **Last Updated**: `2025-02-13`

## Model Configurations
- Dataset: `rslearn_projects/data/sentinel2_vessels/config.json`
- Detector: `rslearn_projects/data/sentinel2_vessels/config.yaml`
